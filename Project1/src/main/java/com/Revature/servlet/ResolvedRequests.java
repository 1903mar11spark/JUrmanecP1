		...
		if(idString != null) {
			...
			try {
				...
				if (employeeJSON != null) {
					...
					System.out.println(om.writeValueAsString(requestService.mgrGetResolvedReqs()));

					response.getWriter().write(om.writeValueAsString(requestService.mgrGetResolvedReqs()));
