...
//@WebServlet("/employee")
public class ManReqServlet extends HttpServlet {
		...
		if(idString != null) {
			try {
				...
				if (employeeJSON != null) { 
					...
					response.getWriter().write(om.writeValueAsString(requestService.getRequestByMgrId(id)));
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		rmbRequest = new Request(0, cost, description, receiptImage,initReqState, employeeId, managerId); 
		...
		*/
		...
		pw.println("<a href=\"request\">make another request</a>");
